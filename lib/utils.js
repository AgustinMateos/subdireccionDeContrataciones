...
import { DOCUMENTOS_CHECKLIST, HOY, NOMBRES_MES, TIPOS_SIN_APERTURA, HORARIOS_APERTURA } from "./constants";
...
export function documentacionDeExpediente(exp) {
  ...
  return DOCUMENTOS_CHECKLIST.map(item => ({ item, cargado: false }));
}
